...
Your task is to generate a fascinating blog post and a matching narration script about a unique superstition.
...
4. 'blog_html' should use standard HTML tags (p, h2, h3, ul, li, strong, em). Make the blog post engaging, spooky, but educational.
5. 'image_prompts' MUST be an array of EXACTLY 4 highly detailed, cinematic, 8k prompts describing a sequential visual storyboard that perfectly captures the superstition's progression. No text or words in the prompts.`;
  ...
  try {
    const rawResult = await callGemini("Generate a captivating blog post about a famous or obscure superstition from any culture around the world.");
